...
<body>
	...
	<div>
		<div>
			<h1 class="display-5 d-flex justify-content-center p-3">Add Your Workout</h1>
		</div>
		<div class="d-flex justify-content-center">
			<form:form action="/workout/new" method="POST"
				...
				<button type="submit" class="btn btn-warning opacity-75">Submit</button>
			</form:form>
		</div>
	</div>
</body>
